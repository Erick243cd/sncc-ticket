            ...
            <div class="col-lg-12">
                <div class="form-box">
                    <div class="form-title-wrap">
                        <h3 class="title"><i class="la la-city mr-2 text-gray"></i>Booking Confirmation</h3>
                    </div><!-- form-title-wrap -->
                    <div class="form-content contact-form-action">
                        <?= form_open('bookings/confirmBooking/'.$booking->booking_id)?>
                        <div class="row">
                            <div class="col-lg-6 responsive-column">
                                <div class="input-box">
                                    <label class="label-text">Reservation number</label>
                                    <div class="form-group">
                                        <span class="la la-air-freshener form-icon"></span>
                                        <input class="form-control" type="text" name="rsv_number" placeholder="Reservation Number" required>
                                    </div>
                                </div>
                            </div><!-- end col-lg-6 -->
                            <div class="col-lg-6 responsive-column">
